...
public class ApplicantInfoPage {
	...
	@FindBy(xpath = "//div[@id='academicsDegreeType']/div/span")
	WebElement FullParttimedrop;
	@FindBy(xpath = "//div[@id='academicsDegreeType']/input")
	WebElement Fullpartsearch;
	@FindBy(xpath = "//div[@id='academicsMinorLabel']/a")
	WebElement minorlink;
	@FindBy(xpath = "//div[@id='MultiSelectModal']//button[@ng-class = 'settings.buttonClasses']")
	WebElement popupdropdown;
	@FindBy(xpath = "//div[@id= 'MultiSelectModal']//div[@class = 'modal-footer']/button[text()='Add']")
	WebElement popupAddbutton;
	@FindBy(xpath = "//div[@id='academicsConcentrationLabel']/a")
	WebElement concentrationlink;
	@FindBy(xpath = "//div[@id='MultiSelectModal']//button[@ng-class = 'settings.buttonClasses']")
	WebElement concentrationdrop;
	@FindBy(xpath = "//div[@id='admitCode']/div/span")
	WebElement admitcodedrop;
	@FindBy(xpath = "//div[@id='admitCode']/input")
	WebElement admitcodesearch;
	@FindBy(xpath = "//div[@id='campusCode']/div/span")
	WebElement campusCodedrop;
	@FindBy(xpath = "//div[@id='campusCode']/input")
	WebElement campusCodesearch;
	@FindBy(xpath = "//div[@id='residencyCode']/div/span")
	WebElement residencyCodedrop;
	@FindBy(xpath = "//div[@id='residencyCode']/input")
	WebElement residencyCodesearch;
	@FindBy(xpath = "//div[@id='sourceHeardAboutUs']/div/span")
	WebElement sourceHeardAboutUsdrop;
	@FindBy(xpath = "//div[@id='sourceHeardAboutUs']/input")
	WebElement sourceHeardAboutUssearch;
	@FindBy(xpath = "//div[@class='titleHead']//div//button[2]")
	WebElement Savebutton;
	@FindBy(xpath = "//*[@id=\"SelfServiceApp\"]/body/section/ng-view/section/div[2]/form/div/div[1]/div/div[2]/button[3]") WebElement SubmitApplication;
	...
	public DashboardSS applicantdata(String fullparttime, String admitcode, String resdencycode,
			String primarysource) throws InterruptedException {
