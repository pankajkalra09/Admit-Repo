...
public class Admin_Flow extends BaseClass {
	...
	public void GetInstitutionalDefaultItemNames() throws Exception {
		GetInstNname Dashboard_obj1 = new GetInstNname(driver);
		Dashboard_obj1.InstitutionalDefaultPae();
	}
	@AfterTest
